...
TankSteering::TankSteering(ros::NodeHandle roshandle, Epos2MotorController* epos[2], double wheelPerimeter, double axisLength, double maxMPS, double odomDuration, double velocityDuration)
{
